...
def checkio(hands,category):
	...
	if not 'Four of a Kind' in category and ([e[1] for e in numbers.most_common(1)]==[4] or [e[1] for e in numbers.most_common(1)]==[5]):
		...
		return [e for e in hands if e[0]==numbers.most_common(1)[0]]
	...
	if not 'Two Pair' in category and ([e[1] for e in numbers.most_common(2)]==[2,2] or [e[1] for e in numbers.most_common(2)]==[3,2]):
		return 'Two Pair'
	if not 'One Pair' in category and ([e[1] for e in numbers.most_common(1)]==[2] or [e[1] for e in numbers.most_common(1)]==[3] or [e[1] for e in numbers.most_common(1)]==[4] or [e[1] for e in numbers.most_common(1)]==[5]):
