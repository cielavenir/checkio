...
if __name__=='__main__':
	assert decode_vigenere('DONTWORRYBEHAPPY', 'FVRVGWFTFFGRIDRF', 'DLLCZXMFVRVGWFTF') == "BEHAPPYDONTWORRY"
	assert decode_vigenere('ANODSASGOODASAWINKTOABLINDBATEH', 'MBBWQMGTHMPOFTUUBXMMMPYBLPPNMCT',
